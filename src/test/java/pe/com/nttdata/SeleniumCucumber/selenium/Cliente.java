...
public class Cliente extends BaseSelenium {
    ...
    public void altaCliente() {
        ...
        driver.findElement(By.id("nombre")).sendKeys("henry");
        driver.findElement(By.id("apellido")).click();
        driver.findElement(By.id("apellido")).sendKeys("ilizarbe");
        driver.findElement(By.id("direccion")).click();
        driver.findElement(By.id("direccion")).sendKeys("direccionnnn");
        driver.findElement(By.id("telefono")).click();
        driver.findElement(By.id("telefono")).sendKeys("987654321");
        driver.findElement(By.id("email")).click();
        driver.findElement(By.id("email")).sendKeys("christophermen@gmail.com");
